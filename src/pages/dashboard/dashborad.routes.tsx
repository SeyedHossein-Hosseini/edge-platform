...
const EntranceHistory = lazy(
  () => import("src/pages/dashboard/entrance-history")
);
...
const RestrictedHistory = lazy(
  () => import("src/pages/dashboard/restricted-history")
);
const RestrictedSettings = lazy(
  () => import("src/pages/dashboard/restricted-settings")
);
...
const licensePlateHistory = lazy(
  () => import("src/pages/dashboard/license-plate-history")
);
